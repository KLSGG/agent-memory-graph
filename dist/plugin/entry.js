...
// src/config/defaults.ts
var CONFIG_FILENAME = "graph.config.json";
...
// src/extract/local-extractor.ts
var PROPER_NOUN_RE = /\b([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)\b/g;
var TYPE_INDICATORS = {
  Person: [
...
var STOP_ENTITIES = /* @__PURE__ */ new Set([
  "The",
  "This",
  "That",
  "These",
...
// src/search/natural-language.ts
