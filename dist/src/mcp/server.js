    ...
    async callTool(name, args) {
        switch (name) {
            ...
            case 'memory_graph_temporal': {
                ...
                if (!entity)
                    return { content: [{ type: 'text', text: `Entity "${args.entity}" not found.` }] };
            ...
            case 'memory_graph_supersede': {
                const result = this.engine.supersedeRelation(args.entity, args.relation, args.oldTarget, args.newTarget, { source: args.source || 'mcp' });
